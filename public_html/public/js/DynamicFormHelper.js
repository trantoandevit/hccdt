...
function DynamicFormHelper(data, file,f) {
    ...
    this.checkValidate = function(control_id, name, allow, validate) {
        ...
        switch (validate) {
            ...
            case "ddli": //drop down list box validate
                ...
                break;
            case "unsignNumber": //unsigned number validate
                mess = mess + this.checkUnsignNumber(control_id, name, allow);
                break;
     ...
     * @returns {String}
     */
    this.checkUnsignNumber = function(control_id, name, allow) {
        var mess = "";
        ...
        if (allow == "no") {
            if (this.isEmpty(number)) {
                ...
                {
                    mess = mess + " " + name + " phải là số nguyên dương!";
                }
            }
        }
        else
