...
$mcImageManagerConfig['filesystem.path'] = "../../../../../upload/"; // absolute or relative from this script path, optional.
$mcImageManagerConfig['filesystem.rootpath'] = "../../../../../upload/"; // absolute or relative from this script path, required.
