                    ...
                    for ($i=0, $n=sizeof($arr_all_report_data); $i<$n; $i++)
                    {
                        ...
                        if($v_current_spec != $v_spec_code)
                        {
                            ...
                            echo "<tr data-spec='$v_spec_code'>
                                    ...
                                    <td class='end center' data-index = '7' data-sum='1' data-format='1'></td>
                                    <td class='end center' data-index = '8' data-sum='1' data-format='1'></td>
                                    <td class='end center' data-index = '9' data-sum='1' data-format='1'></td>
                                  </tr>";
                        }
                        ?>
