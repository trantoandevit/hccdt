...
<?php
    ...
    $sel_village = get_post_var('sel_village','');
    ...
    <div class="div-synthesis" style="margin-top: 0">
        ...
        <div class="div_title">
            <div class="title-content">
                <label>
                    <?php echo __('Thống kê tổng hợp tình trạng giải quyết hồ sơ theo đơn vị')?>
                </label>
            </div>
        </div>
      ...
      <div class="col-md-12">
            ...
            <div class="form-group period_option" id="period_month" >
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="col-md-5 block">
                                <select class="form-control" name='sel_year_month' id='sel_year_month'>
                                    <?php
                    ...
                    <tr>
                        ...
                        <th class="orange"><?php echo __('Kỳ trước'); ?></th>
                            ...
                            for ($i =0;$i <count($arr_all_report_data);$i ++):                                
                                ...
                                $v_unit_code             = isset($arr_value['C_UNIT_CODE']) ? $arr_value['C_UNIT_CODE'] : '';
                            ...
                            ?>
                    <?php  if($v_unit_code != $v_cur_unit_code ):?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.table_synthesis tr[data-total="true"]').each(function()
        {
            ...
            var sum_qua_han     = $(this).find('td:eq('+ 9 +')').html() || 0;
            var sum_tong_tra    = parseInt(sum_som_han) + parseInt(sum_dung_han) + parseInt(sum_qua_han);
            var  ty_le = '';
            if(parseInt(sum_tong_tra) > 0)
            {
                ty_le = number_format(((parseInt(sum_som_han) + parseInt(sum_dung_han)) / parseInt(sum_tong_tra) * 100),3);
            }
            if(ty_le == '')
            {
                ty_le = '--';
