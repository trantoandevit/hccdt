    ...
    <div class="div-synthesis">
        ...
        <div class="div_title">
             <div class="title-content">
                <label>
                    <?php echo __('statistical records denied')?>
                </label>
             </div>
        </div>
                ...
                <table class="table_synthesis">
                    ...
                    for ($i=0, $n=sizeof($arr_all_report_data); $i<$n; $i++)
                    {
                        ...
                        <tr data-spec-child="<?php echo $v_spec_code?>">
                            ...
                            <td data-format='1' class="blue center"><?php echo $v_tu_choi?></td>
                            <td data-format='1' class="right blue center"><?php echo $v_cong_dan_rut;?></td>
                        </tr>
                        <?php 
                    }//end for i
                    ?>
