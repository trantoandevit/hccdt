    ...
    <div class="div-synthesis">
        ...
        <div class="div_title">
             <div class="title-content">
                <label>
                    <?php echo __('statistics records for supplements')?>
                </label>
             </div>
        </div>
            ...
            <div id="result" class="div-synthesis">
                ...
                <table class="table_synthesis">
                    <tr>
                        ...
                        <th class="top green" colspan="4"><?php echo __('processing')?></th>
                    </tr>
                    <tr>                
                        <th class="green"><?php echo __('supplements')?></th>
                        <th class="green"><?php echo __('tax')?></th>
                    </tr>
                    <?php 
                    ...
                    for ($i=0, $n=sizeof($arr_all_report_data); $i<$n; $i++)
                    {
                        ...
                        $v_thue    = $arr_report_data['C_COUNT_THUE'];
                        $v_bo_sung = $arr_report_data['C_COUNT_BO_SUNG'];
                        ?>
                        <?php 
                        ...
                        <tr data-unit="<?php echo $v_unit_code?>">
                            ...
                            <td data-format='1' class="green center"><?php echo $v_bo_sung?></td>
                            <td data-format='1' class="right green center"><?php echo $v_thue;?></td>
                        </tr>
                        <?php 
                    }//end for i
                    ?>
