...
<form name="frmMain" method="post" id="frmMain" action=""><?php
    ...
    <div class="button-area">
        <input type="button" name="update" class="ButtonAccept" value="<?php echo __('update'); ?>" onclick="tinyMCE.triggerSave(); btn_update_onclick();"/>
        <input type="button" name="cancel" class="ButtonBack" value="<?php echo __('go back'); ?>" onclick="btn_back_onclick();"/>
    </div>
</form>
