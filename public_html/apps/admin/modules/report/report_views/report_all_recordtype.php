...
$this->template->title = __('report recordtype');
...
$v_quarter  = get_post_var('sel_quarters',1);
...
<h2 class="module_title"><?php echo __('report recordtype') ?></h2>
...
<div class="" id="filter">
    ...
    <div class="Row">
        ...
        <div class="right-Col">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label><input value="quarters" type="radio" id="rd_quarter" name="rd_date" onclick="rd_onclick_date(this)" /><?php echo __('quarter') ?></label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="Row" > 
                ...
                <div class="right-Col" >
                    ...
                    <div id="div-rd_quarter" class="Row" style="width: 35%;float: left;display: none" >
                        ...
                        <div class="right-Col">
                            <select name="sel_quarters" id="sel_quarters" style="width: 80%">
                                 <?php
                                    for($i = 1;$i<= 4 ;$i ++)
                                    {
...
<script>
    ...
    function print_member() 
    {
        ...
        var sel_quarters  = $('#sel_quarters').val() || 0;        
        var sel_rd_date  = $('input[name="rd_date"]:checked').val() || '';
        
        var params = '';
        params += '&district='+ sel_district +  '&month=' + sel_month  + '&year=' +sel_year + '&quarters=' + sel_quarters + '&type_time=' + sel_rd_date;
