...
//        ini_set('memory_limit', '500M');
//        
//        $sql = "SELECT PK_CATEGORY,FK_WEBSITE FROM t_ps_category";
...
//            $sql = "SELECT DISTINCT FK_ARTICLE FROM t_ps_category_article WHERE FK_CATEGORY = ?";
...
//    }
    ...
    public function article_entity_endcode()
    {
        ...
        for($i=78000;$i<=82864;$i++)
        {
            ...
            //lay du lieu
            $sql = "SELECT PK_ARTICLE,C_CONTENT,C_SUMMARY FROM t_ps_article $v_str_limit";
