...
<form class="grid_23" name="frmMain" id="frmMain" action="#" method="post">
    ...
    <div id="left-article" class="grid_16">
        ...
        <div class="Row">
            ...
            <div class="right-Col">
                <input type="text" name="txt_tags" value="<?php echo $v_tags; ?>" id="txt_tags"
                       ...
                       data-xml="no" data-doc="no"
                       />
                <img height="20" src="<?php echo SITE_ROOT . 'public/images/tags.png' ?>" onclick="dsp_service_tags()"/>
            </div>
        </div>
        <div class="Row">
            <div class="left-Col">
        ...
        <div class="Row" style="display: none">
            ...
            <div class="right-Col">
                 <select name="sel_employee" id="sel_employee" style="width:200px;" >
...
<script>
    ...
    function frm_on_submit(){
        ...
        if(! $('#txt_summary').val())
        {
            $('#txt_summary').before('<span id="text-sumary-error" class="required">Trường này không được để trống</span>');
            is_form_valid = false;
            $err_msg = '<?php echo __('update error, please check all required field') ?>';
        }
        else
        {
            $('#text-sumary-error').hide();
        }
