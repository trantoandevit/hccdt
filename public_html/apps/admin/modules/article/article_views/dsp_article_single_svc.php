...
$this->template->title = 'Them/Sua bai viet';
$this->template->display('dsp_admin_header.php');
...
<form id="frm_main" action="" method="post">
    ...
    <?php echo $this->hidden('hdn_thumb_img',$v_thumb_img); ?>
...
<?php
$this->template->display('dsp_admin_footer.php')?>